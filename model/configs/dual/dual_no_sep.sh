...
#SBATCH -o /n/home11/jxhe/insert-any/insert_anything/sd_style/logs/dual_no_sep.out  # File to which STDOUT will be written, %j inserts jobid
#SBATCH -e /n/home11/jxhe/insert-any/insert_anything/sd_style/logs/dual_no_sep.err  # File to which STDERR will be written, %j inserts jobid
...
python /n/home11/jxhe/insert-any/insert_anything/sd_style/main.py \
    --base /n/home11/jxhe/insert-any/insert_anything/sd_style/configs/dual/dual_no_sep.yaml \
    -t \
    --gpus 2 \
    --name dual_no_sep \
