...
#SBATCH -o /n/home11/jxhe/insert-any/insert_anything/sd_style/logs/dual_2.5e-4.out  # File to which STDOUT will be written, %j inserts jobid
#SBATCH -e /n/home11/jxhe/insert-any/insert_anything/sd_style/logs/dual_2.5e-4.err  # File to which STDERR will be written, %j inserts jobid
...
python /n/home11/jxhe/insert-any/insert_anything/sd_style/main.py \
    --base /n/home11/jxhe/insert-any/insert_anything/sd_style/configs/dual/dual_2.5e-4.yaml \
    -t \
    --gpus 2 \
    --name dual_2.5e-4 \
